...
final class ClassSourceManipulator
{
    ...
    /**
     * @param \PhpParser\Node\Attribute[] $attribute
     */
    public function addEntityField(ClassProperty $mapping, array $attributes = []): void
    {
     ...
     */
    public function addManyToOneRelation(RelationManyToOne $manyToOne, $attribute = []): void
    {
        $this->addSingularRelation($manyToOne, $attribute);
    }
    
    /**
     * @param \PhpParser\Node\Attribute[] $attributes
     */
    public function addOneToOneRelation(RelationOneToOne $oneToOne, $attribute = []): void
    {
        $this->addSingularRelation($oneToOne, $attribute);
    }

    /**
     * @param \PhpParser\Node\Attribute[] $attributes
     */
    public function addOneToManyRelation(RelationOneToMany $oneToMany, $attribute = []): void
    {
        $this->addCollectionRelation($oneToMany, $attribute);
    }

    /**
     * @param \PhpParser\Node\Attribute[] $attributes
     */
    public function addManyToManyRelation(RelationManyToMany $manyToMany, $attribute = []): void
    {
        $this->addCollectionRelation($manyToMany, $attribute);
    }
     ...
     * @param \PhpParser\Node\Attribute[] $attributes
     */
    private function addSingularRelation(BaseRelation $relation, array $attributes): void
    {
     ...
     * @param \PhpParser\Node\Attribute[] $attributes
     */
    private function addCollectionRelation(BaseCollectionRelation $relation, array $attributes): void
    {
